...
<a href="{{ route('limit') }}" class="btn btn-outline rounded-pill"><i class="fa-solid fa-file"></i> ကန့်သတ်</a>
<a href="{{ route('weekreport') }}" class="btn btn-outline rounded-pill"><i class="fa-solid fa-list"></i> စာရင်းချုပ်</a> 
